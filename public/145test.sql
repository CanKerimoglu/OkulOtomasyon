...
INSERT INTO `tbl_odev` VALUES (13,'Sayilar','05/23/2014','05/07/2014','Matematik');

#
# Structure for table "tbl_sinav"
#

DROP TABLE IF EXISTS `tbl_sinav`;
CREATE TABLE `tbl_sinav` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ders_adi` varchar(255) DEFAULT NULL,
  `sinav_tarih` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

#
# Data for table "tbl_sinav"
#

INSERT INTO `tbl_sinav` VALUES (3,'Matematik','05/06/2014'),(4,'Fizik','05/15/2014');
